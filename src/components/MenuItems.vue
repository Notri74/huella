    ...
    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
      <div class="btn-group" role="group">
        ...
        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
          ...
          <div class="dropdown-item" v-for="y of years" @click="formData.year = y" :key="y">
            {{ y }}
          </div>
        </div>
      </div>
      <div class="btn-group language-button" :class="formData.language.toLowerCase()" role="group">
        <button id="btnGroupDrop1" type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown"
          aria-haspopup="true" aria-expanded="false">
          <img :src="flags[formData.language as keyof typeof flags]" class="flag" alt="" />
        ...
        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
          ...
          <div class="dropdown-item" v-for="l of languages" :key="l"
            :class="[l.toLowerCase(), 'd-flex', 'align-items-center']" @click="formData.language = l">
      ...
      <div class="btn-group" role="group">
        ...
        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
          ...
          <div class="dropdown-item" v-for="i of isos" @click="formData.iso = i" :key="i">
            {{ i }}
          </div>
        </div>
      </div>
